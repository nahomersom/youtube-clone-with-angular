(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DEFAULT_BACKGROUNDFN = function (set, sheetSize) { return "https://unpkg.com/emoji-datasource-" + set + "@6.0.1/img/" + set + "/sheets-256/" + sheetSize + ".png"; };
    var EmojiService = /** @class */ (function () {
        ...
        EmojiService.prototype.uncompress = function (list) {
            ...
            this.emojis = list.map(function (emoji) {
                ...
                if (data.obsoletes) {
                    ...
                    if (f) {
                        if (f.keywords) {
                            data.keywords = __spreadArray(__spreadArray(__spreadArray([], __read(data.keywords)), __read(f.keywords)), [f.shortName]);
                        }
                        else {
                            data.keywords = __spreadArray(__spreadArray([], __read(data.keywords)), [f.shortName]);
                        }
                    }
                }
        ...
        EmojiService.prototype.unifiedToNative = function (unified) {
            ...
            return String.fromCodePoint.apply(String, __spreadArray([], __read(codePoints)));
        };
    ...
    EmojiService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function EmojiService_Factory() { return new EmojiService(); }, token: EmojiService, providedIn: "root" });
